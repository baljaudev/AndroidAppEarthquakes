...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, OnFiltroListener {
    ...
    private void insertarPaises() {
        ...
        pDao.insert(new PaisAfectado("11 de marzo de 2011, 14:46", "Japón"));
        ...
        pDao.insert(new PaisAfectado("28 de octubre de 1746, 22:30", "Perú"));
        ...
        pDao.insert(new PaisAfectado("6 de febrero de 2023, 01:17", "Turquía"));
        ...
        pDao.insert(new PaisAfectado("28 de marzo de 1787, 11:30", "México"));
        pDao.insert(new PaisAfectado("3 de febrero de 1923, 04:58", "Rusia"));
        pDao.insert(new PaisAfectado("20 de octubre de 1687, 09:15", "Perú"));
        ...
        pDao.insert(new PaisAfectado("23 de junio de 2001, 15:33","Perú"));
    }

    private void insertarTerremotos() {
        tDao.insert(new Terremoto("22 de mayo de 1960, 15:11", 9.5, "Terremoto de Valdivia de 1960", "Valdivia, Región de los Ríos", "38°14′24″S 73°3′0″O", "1655 a 2000"));
        tDao.insert(new Terremoto("26 de diciembre de 2004, 07:58", 9.3, "Terremoto del océano Índico de 2004", "Frente al norte de la isla de Sumatra", "Sin datos", "230270"));
        tDao.insert(new Terremoto("27 de marzo de 1964, 17:36", 9.2, "Terremoto de Alaska de 1964", "Anchorage, Alaska", "61°N 148°O", "128"));
        tDao.insert(new Terremoto("11 de marzo de 2011, 14:46", 9.1, "Terremoto y maremoto de Japón de 2011", "Costa Este de la Región de Tōhoku, Honshū", "38°19′19.20″N 142°22′8.40″E", "15897"));
        tDao.insert(new Terremoto("4 de noviembre de 1952, 16:58", 9.0, "Terremoto de Kamchatka de 1952", "Península de Kamchatka", "52°48′N 159°30′E", "2366"));
        ...
        tDao.insert(new Terremoto("26 de enero de 1700, 21:30", 9.0, "Terremoto de Cascadia de 1700", "California, Oregón, Washington y Columbia Británica", "Sin datos", "Sin datos"));
        tDao.insert(new Terremoto("27 de febrero de 2010, 03:34", 8.8, "Terremoto de Chile de 2010", "Cobquecura, Región del Biobío (actual Ñuble)", "35°50′45.6″S 72°42′57.6″O", "525"));
        ...
        tDao.insert(new Terremoto("8 de julio de 1730, 04:45", 8.7, "Terremoto de Valparaíso de 1730", "Valparaíso y La Serena", "33°30′S 71°36′O", "300"));
        tDao.insert(new Terremoto("11 de abril de 2012, 15:38", 8.6, "Terremoto del océano Índico de 2012", "Frente al norte de la isla de Sumatra", "02°18′39.6″N 93°03′46.8″E", "10"));
        ...
        tDao.insert(new Terremoto("15 de agosto de 1950", 8.6, "Terremoto de Assam de 1950", "Assam (India)); Tíbet (China)", "28°30′N 96°30′O", "1526"));
        tDao.insert(new Terremoto("10 de noviembre de 1922, 23:53", 8.6, "Terremoto de Vallenar de 1922 Chile", "Región de Atacama y Provincia de Catamarca", "Sin datos", "1500"));
        tDao.insert(new Terremoto("28 de marzo de 1787, 11:30", 8.6, "Terremoto de Nueva España de 1787", "Costas de Oaxaca y Guerrero", "Sin datos", "11"));
        tDao.insert(new Terremoto("3 de febrero de 1923, 04:58", 8.5, "Terremoto de Kamchatka de 1923", "Península de Kamchatka", "54°N 161°E", "Sin datos"));
        ...
        tDao.insert(new Terremoto("16 de septiembre de 2015, 19:54", 8.4, "Terremoto de Coquimbo de 2015", "Frente a las costas de la Comuna de Canela, Región de Coquimbo", "31°34′52″S 71°45′07″O", "12"));
        tDao.insert(new Terremoto("23 de junio de 2001, 15:33", 8.4, "Terremoto del sur del Perú de 2001", "Departamentos de Arequipa, Moquegua y Tacna", "16°15′36″S 73°38′24″O", "102"));
        tDao.insert(new Terremoto("6 de febrero de 2023, 01:17", 7.8, "Terremoto de Turquía y Siria 2023", "Turquía, Siria", "37°10′26″N 37°01′55″E", "40120"));
    ...
    public void onFiltroListener(String mes, String anio, String pais) {
        tvFiltroUsado.setText("Mes: " + mes + ".Año: " + anio + ".País: " + pais);
        this.mes=mes;
        this.anio=anio;
        this.pais=pais;
    }
